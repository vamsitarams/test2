...
export default {
  api: {
    endpoint: 'https://lhmv42z4ql.execute-api.us-east-1.amazonaws.com/QA',
    xApiKey: 'NDDdM3aqXS32B3SiQJwRQ6oD3LXi2rpA8wPOQQ4s'
  },
  googleAnalytics: {
  ...
  links: {
    ...
    covid19stateRestrictionsPdf: 'https://worldwatch-qa.s3.amazonaws.com/Pdfs/ww-states-restrictions.pdf',
